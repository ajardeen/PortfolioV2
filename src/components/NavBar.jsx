...
function NavBar() {
  ...
  return (
    <motion.div
      ...
      className="px-3 py-2 mx-10 my-2 rounded-t-3xl text-sm fixed bottom-0 flex justify-around items-center z-30 w-72 lg:w-96 backdrop-blur-lg shadow-sm shadow-slate-700"
    >
